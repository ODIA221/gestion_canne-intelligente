          ...
          {filteredData.length === 0 ? (
            ...
            filteredData.slice(startIndex, endIndex).map((item: any) => (
              <tr key={item.id}>
                ...
                <td className="ico">
                  <span
                    className="material-symbols-outlined" id="con"
                  ...
                  <button className="info">
                    <Link to="/Dashbord/Modifmdp" className='lien'> <span className="material-symbols-outlined"
                    title="informations"
                    >
                      info 
                    </span> </Link></button>
                    ...
                    <button className="info">
                    <Link to="/Dashbord/Donneconcerne" className='lien'> <span class="material-symbols-outlined">
border_color
</span></Link></button>
                </td>
