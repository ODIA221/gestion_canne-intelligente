              ...
              <tr key={item.id}>
                ...
                <td className="ico">
                  ...
                  <button className="info">
                    <Link to="/Dashbord/DonneconcerneModifmdp" className='lien'> <span className="material-symbols-outlined" id="inf"
                      title="informations"
                    >
                      info
                    </span> </Link></button>
                  ...
                  <button className="info">
                    <Link to="/Dashbord/Donneconcerne" className='lien'> <span className="material-symbols-outlined" id="icon">
                      border_color
                    </span></Link></button>
                </td>
