          ...
          {filteredData.length === 0 ? (
            ...
            filteredData.slice(startIndex, endIndex).map((item: any)    => (
              <tr key={item.id}>
                ...
                title="info"
                onClick={() => Navigate ("./Donneconcerne.tsx")}
                <button id="btnMenuNav"><span className="material-symbols-outlined"<Link to="/Dashbord/Donneconcerne" className='lien'> Informations </Link></button> 
