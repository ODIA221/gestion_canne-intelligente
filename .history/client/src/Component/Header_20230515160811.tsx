  ...
  return (
    <div id='entête'>
      ...
      <button id="btnMenuNav"><Link to="/">Se déconnecter </Link></button> 
           ...
           <button id="btnMenuNav"><Link to="/Dashbord/Inscription" className='lien'> <Inscrire></Inscrire></Link></button> 
           <button id="btnMenuNav"><Link to="/Dashbord/Donneconcerne" className='lien'> client </Link></button> 
