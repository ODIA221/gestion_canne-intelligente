  ...
  return (
    <div id='entête'>
      ...
      <button id="btnMenuNav"><Link to="/">Se déconnecter </Link></button> 
           ...
           <div id='menuNav' >
           <button id="btnMenuNav"><Link to="/Dashboard/Admin" className='links'> Tableau de bord  </Link></button>
           <button id="btnMenuNav"><Link to="/Dashboard/Inscription" className='links'> Inscrire un utilisateur </Link></button> 
