  ...
  return (
    <div id='entête'>
      ...
      <button id="btnMenuNav"><Link to="/">Se déconnecter </Link></button> 
           ...
           <div id='menuNav' >
           <button id="btnMenuNav"><Link to="/Dashboad/Admin" className='lien'> Tableau de bord  </Link></button>
           <button id="btnMenuNav"><Link to="/Dashboad/Inscription" className='lien'> Inscrire un utilisateur </Link></button> 
